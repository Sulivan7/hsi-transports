...
import { AboutSection, ContentWrapper, TextContainer, ImageContainer} from './styles';
      ...
      <ContentWrapper>
        <TextContainer>
          <h1>
            ...
            discretos, priorizando sempre a segurança, pontualidade, privacidade,
            conforto e confiança dos nossos clientes.
          </h1>
          <p>
